...
Please note that the simulation does not approximate real world values, but rather simulates the properties of the light wave due to a lack of CPU/GPU power.
